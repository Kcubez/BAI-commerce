...
export async function sendOTPEmail(recipientEmail: string, otpCode: string): Promise<boolean> {
  ...
  const senderName = process.env.BREVO_SENDER_NAME || "BAI-Commerce";
        ...
        htmlContent: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px; background-color: #ffffff;">
            <div style="text-align: center; margin-bottom: 20px;">
              <h2 style="color: #0284c7; margin: 0;">BAI-Commerce</h2>
            ...
            <p style="color: #94a3b8; font-size: 12px; line-height: 1.5; text-align: center;">
              This email was generated automatically by the BAI-Commerce Platform. Please do not reply directly to this email.
            </p>
          </div>
        `,
      }),
